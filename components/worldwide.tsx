...
export function Worldwide() {
  ...
  const colors = ["#fab076", "#f3cb82", "#fcc79e"];
  const sampleArcs = [
    {
      order: 1,
      startLat: -19.885592,
  ...
  return (
    <div className="relative flex h-screen w-full flex-col items-center justify-center dark:bg-black md:h-auto">
      <div className="">
        <Heading>Une vision internationale</Heading>
        <Subheading>
